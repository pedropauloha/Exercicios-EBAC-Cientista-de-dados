...
def main():
    ...
    # SIDEBAR
    # image = Image.open('img/Bank-Branding')
    st.sidebar.image(image="https://raw.githubusercontent.com/pedropauloha/Exercicios-EBAC-Cientista-de-dados/main/img/telmarketing_icon.png")

    # TÍTULO
    st.markdown('''
    <div style="text-align:center">
        <a href="https://github.com/pedropauloha/Exercicios-EBAC-Cientista-de-dados">
            <img src="https://raw.githubusercontent.com/pedropauloha/Exercicios-EBAC-Cientista-de-dados/main/img/ebac_logo-data_science.png" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Data da entrega:** 4 de maio de 2023.
    ...
    bank_raw = load_data(
        file_data='https://raw.githubusercontent.com/pedropauloha/Exercicios-EBAC-Cientista-de-dados/main/data/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
